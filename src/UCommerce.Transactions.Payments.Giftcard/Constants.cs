...
namespace UCommerce.Transactions.Payments.GiftCard
{
    ...
    public class Constants
	{
	    ...
	    public static readonly string GiftCardProductDefinitionField = "GiftCardDefinitionField";
        public static readonly string GiftCardPaymentDefinitionName = "PaymentMethod Definitions";
        public static readonly string GiftCardPaymentDefinitionFieldAcceptUrl = "AcceptUrl";
